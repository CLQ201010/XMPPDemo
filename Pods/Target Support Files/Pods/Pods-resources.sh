...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "TREmotion/Resources/Emoji.plist"
  install_resource "TREmotion/Resources/TRKeyboardEmojiViewController.xib"
  install_resource "TREmotion/Resources/emotions.bundle"
