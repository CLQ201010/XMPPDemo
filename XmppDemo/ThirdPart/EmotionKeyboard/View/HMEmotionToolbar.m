...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // 1.添加4个按钮
        [self setupButton:nil image:@"emoticon_recent" tag:HMEmotionTypeRecent];
        [self setupButton:nil image:@"emoticon_default" tag:HMEmotionTypeDefault];
        [self setupButton:nil image:@"emoticon_emoji" tag:HMEmotionTypeEmoji];
        [self setupButton:nil image:@"emoticon_lxh" tag:HMEmotionTypeLxh];
      //2.添加发送按钮
