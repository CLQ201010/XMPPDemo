...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        [self.btnCheckMark setImage:[UIImage imageNamed:@"picker_checkHL"] forState:UIControlStateSelected];
        [self.btnCheckMark setImage:[UIImage imageNamed:@"picker_check"] forState:UIControlStateNormal];
    }
    return self;
}
